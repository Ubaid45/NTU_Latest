...
(function ($) {
    ...
    $.fn.visualizeNewLine = function (options, container) {
        return $(this).each(function () {
            //configuration
            var o = $.extend({
                type: 'bar', //also available: area, pie, line
                width: 488, //height of canvas - defaults to table height
                height: 160,// $(this).height(), //height of canvas - defaults to table height
                appendTitle: true, //table caption text is added to chart
                title: null, //grabs from table caption if null
                appendKey: true, //color key is added to chart
                colors: ['#c0392b', '#2ecc71', '#e64c65', '#11a8ab', '#2ecc71', '#5a3b16', '#26a4ed', '#f45a90', '#e9e744'],
            ...
            var canvasContain = (container || $('<div ' + (o.chartId ? 'id="' + o.chartId + '" ' : '') + 'class="visualize visualizeLine" role="img" aria-label="Chart representing data from the table: ' + title + '" />'))
                .height(o.height)
                .width(o.width);
            ...
            if (o.appendKey) {
                ...
                $.each(yAllLabels, function (i, label) {
                    if (typeof (dataGroups[i]) != "undefined")
    ...
    $.fn.visualizeNewPieFn = function (options, container) {
        return $(this).each(function () {
            //configuration
            var o = $.extend({
                type: 'pie', //also available: area, pie, line
                width: 291, //height of canvas - defaults to table height
                height: 208,// $(this).height(), //height of canvas - defaults to table height
                appendTitle: true, //table caption text is added to chart
                title: null, //grabs from table caption if null
                appendKey: true, //color key is added to chart
                colors: ['#c0392b', '#27ae60', '#e64c65', '#11a8ab', '#2ecc71', '#5a3b16', '#26a4ed', '#f45a90', '#e9e744'],
                textColors: [], //corresponds with colors array. null/undefined items will fall back to CSS
                parseDirection: 'y', //which direction to parse the table data
                pieMargin: 10, //pie charts only - spacing around pie
                pieLabelsAsPercent: true,
    ...
    $.fn.visualize = function (options, container) {
        return $(this).each(function () {
            ...
            var o = $.extend({
                type: 'bar', //also available: area, pie, line
                width: 253, //height of canvas - defaults to table height
                height: 160,// $(this).height(), //height of canvas - defaults to table height
                appendTitle: true, //table caption text is added to chart
                title: null, //grabs from table caption if null
                appendKey: true, //color key is added to chart
            ...
            var createChart = {
                ...
                bar: function () {
                    ...
                    canvasContain.addClass('visualize');
            ...
            canvasNode.setAttribute('id', 'CanvasBar');
            var canvas = $(canvasNode);
            ...
            //create canvas wrapper div, set inline w&h, append
            var canvasContain = (container || $('<div class="visualizeBar" role="img" aria-label="Chart representing data from the table: ' + title + '" />'))
			.height(o.height)
			.width(o.width)
			.append(canvas);
            ...
            //title/key container
            if (o.appendTitle || o.appendKey) {
                var infoContain = $('<div class="visualize-infobar"></div>')
				.appendTo(canvasContain);
            }
...
GetAccountSummaryOfEmployeeCompanyFilter = function (typeOfReport) {
    var concate = "";
    if (typeOfReport == "MonthToDate")
        concate = "GetDayWiseStatsOfEmployeeCompany";
    else if (typeOfReport == "LastMonthChats")
        concate = "GetAccountSummaryOfEmployeeCompanyFilter";
    ...
    //    dataType: "json",
        ...
        success: function (msg) {
            ...
            if (typeOfReport == "MonthToDate")
                $('#tblMONTHTODATE').html(msg);
            else if (typeOfReport == "LastMonthChats")
                $('#tblLASTMONTHCHATS').html(msg);
...
MONTHSCOMPARISON = function () {



    $.ajax({
        type: "POST",
        url: "../Ajax/MONTHSCOMPARISON",
        data: '{' +
